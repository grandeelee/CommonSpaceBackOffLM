...
flags.DEFINE_string("infile", "/home/grandee/Projects/phrases_alignment/final.alignments/pseudo_corpora/",
    ...
    with tf.Graph().as_default() as g:
        ...
        with tf.Session() as sess:
            ...
            if not is_inference:
                ...
                #                                  eval_op=madapt.train_op, verbose=True, istest=False)
                #     logging.info("Epoch: %d Train Perplexity: %.3f" % (i + 1, train_perplexity))
                #
                #     valid_perplexity = run_epoch(sess, mvalid, id_to_word)
                #     logging.info("Epoch: %d Valid Perplexity: %.3f" % (i + 1, valid_perplexity))
            ...
            if is_inference:
                saver.restore(sess, "tmp/pseudo_cs_without_seame_small1_with_mono/model.ckpt-696410")
